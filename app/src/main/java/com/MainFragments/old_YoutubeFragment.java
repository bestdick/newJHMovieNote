 ...
 */
public class old_YoutubeFragment extends Fragment {
...
//    ScrollView scrollView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        _initialLoader( rootView );
        return rootView;
    }

    private void _initialLoader(final View rootView ){
            ...
            public void onSuccess(String result, String connection) {
                ...
                if( connection == null ){
                    try {
                        ...
                        if( res == 0 ) {
                            /**
                             * drop down list for youtube channel list .....
                             */
