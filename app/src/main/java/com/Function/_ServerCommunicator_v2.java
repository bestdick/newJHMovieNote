...
public class _ServerCommunicator_v2 {
    Context context;
    String url;


    public _ServerCommunicator_v2(Context context, String url) {
...
//                Log.e("volley err :: ", error.toString());
    ...
    public void _Communicator(final VolleyCallback callback, final String mode, final String code, final String data) {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    @Override
